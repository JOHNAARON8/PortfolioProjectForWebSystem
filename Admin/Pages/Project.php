<?php include "../Backends/Projects/FetchProjectData.php"; ?>
...
<div class="flex h-screen">
    ...
    <main id="main-content" class="flex-1 overflow-y-auto p-4 md:p-8 md:mr-20">
        ...
        <section id="project-management" class="py-20 bg-gradient-to-b from-gray-900 to-gray-800">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h3 class="text-lg font-semibold mb-4 text-[var(--text-light)]">Add New Project</h3>
            <form method="POST" enctype="multipart/form-data" action="../Backends/Projects/CreateProjectData.php" class="space-y-4">
                ...
                <!-- Tools Input (comma-separated) -->
                <input type="text" name="tools" placeholder="Tools used (separate by comma)" 
                class="w-full p-2 rounded bg-gray-700 border border-gray-600 text-[var(--text-light)]">

                <button type="submit" class="w-full sm:w-auto bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded text-white font-semibold flex items-center justify-center">
            ...
            <div class="bg-[var(--card-dark)] p-6 rounded-xl shadow-md overflow-x-auto">
            <h3 class="text-lg font-semibold mb-4 text-[var(--text-light)]">Existing Projects</h3>
            <table class="min-w-full text-left border-collapse text-[var(--text-light)]">
                <thead>
                ...
                <tr class="border-b border-gray-700 hover:bg-gray-700">
                    ...
                    <!-- View Button -->
                    <button class="bg-blue-500 hover:bg-blue-600 w-full sm:w-20 h-10 rounded text-white text-sm flex items-center justify-center viewProjectBtn"
                            data-id="<?= $proj['id'] ?>"
                    ...
                    <!-- Edit Button -->
                    <button class="bg-yellow-500 hover:bg-yellow-600 w-full sm:w-20 h-10 rounded text-white text-sm flex items-center justify-center editProjectBtn"
                            data-id="<?= $proj['id'] ?>"
                            data-title="<?= htmlspecialchars($proj['title']) ?>"
                            data-short="<?= htmlspecialchars($proj['short_description']) ?>"
                            data-full="<?= htmlspecialchars($proj['full_description']) ?>"
                    ...
                    <form method="POST" action="../Backends/Projects/DeleteProjectData.php" onsubmit="return confirm('Are you sure?');" class="w-full sm:w-auto">
                        ...
                        <button type="submit" class="bg-red-500 hover:bg-red-600 w-full sm:w-20 h-10 rounded text-white text-sm flex items-center justify-center">
    ...
    <!-- for the sidebar, navbar, and modal -->
